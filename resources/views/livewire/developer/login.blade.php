                    ...
                    <div>
                        <form class="space-y-6" method="POST" wire:submit.prevent="postLogin">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input wire:model.defer="username" id="username" type="text" name="username" required autofocus class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                                </div>
                                @error('username')
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input id="password" wire:model.defer="password" class="block mt-1 w-full" type="password" name="password" required class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                                </div>
                                @error('password')
                                <span class="error text-sm font-medium text-red-700">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                <button type="submit" class="flex justify-center py-2.5 px-4 rounded shadow-sm text-sm font-medium text-white bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">Sign
                                    In</button>
                            </div>
                        </form>
                    </div>
